            ...
            <div className="focus-signal-card">
              <div className="fsc-top">
                ...
                <div className="fsc-right">
                  <div className="fsc-price">${focusSignal.price.toLocaleString()}</div>
                  <div className={`fsc-change ${focusSignal.change >= 0 ? 'pos' : 'neg'}`}>
                    {focusSignal.changeP}
                  </div>
                </div>
              </div>
              ...
              <div className="conf-row">
                <span>Confidence: {Math.round(focusSignal.confidence * 100)}%</span>
                <span>Uncertainty: {Math.round((1 - focusSignal.confidence) * 100)}%</span>
              </div>
              <div className="conf-bar-bg">
                <div className="conf-bar-fill" style={{ width: `${focusSignal.confidence * 100}%` }} />
              </div>
            ...
            {signals?.map(s => (
              <div key={s.id} className="signal-item">
                ...
                <div className="si-right">
                  ...
                  <div className="si-entry">${s.price.toLocaleString()}</div>
                </div>
              </div>
            ))}
          </div>
